...
APP_ABI := armeabi-v7a #可用的值为armeabi armeabi-v7a x86 mips,也可以用all
#APP_CFLAGS := #C编译选项
APP_CPPFLAGS += -std=c++11 -frtti -fexceptions #C++编译选项
#APP_BUILD_SCRIPT := Android.mk #默认值
APP_STL := c++_shared #可用的值为system gabi++_static gabi++_shared stlport_static stlport_shared gnustl_static gnustl_shared
